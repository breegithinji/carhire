...
class CarOwner(models.Model):
    """
    This model represents the car owner
    """
    car_owner = models.CharField('Owner', max_length = 200, help_text= 'Enter the name of the owner of the car. If not provided, assumed to belong to the company')
    contact_info = models.CharField('Phone No: ', max_length = 20, help_text = 'Enter the car owners phone number starting with +254')
...
class Car(models.Model):
    ...
    car_owner = models.ForeignKey(CarOwner, default=1, on_delete = models.RESTRICT)
    # car_images = models.ImageField( blank=True)
